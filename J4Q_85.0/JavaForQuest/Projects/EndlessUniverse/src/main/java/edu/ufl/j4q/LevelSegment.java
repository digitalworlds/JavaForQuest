...
public class LevelSegment extends GameObject {
    ...
    private void buildSides(){
        if(sides==null){
            ...
            om.flushModel(sides,true,true);
            sides.mesh.computeNormals();
            sides.setShader(new ShadedTextureShader().setTexture(level.side_texture));
        }
    }
    ...
    private void buildPlanets(){
        if(planets==null){
            ...
            planets=om.flushModel(true,true);
            planets.setShader(new ShadedTextureShader().setTexture(level.planet_texture));
            appendChild(planets);
        }
    }
    ...
    public void buildSegment(LevelSegment previous){
        ...
        if(is_key_frame){
            ...
            if(pipe==null){
                ...
                appendChild(pipe);
                add_texture=true;
                pipe.setShader(new ShadedTextureShader());
            }

            level.path_maker.flushModel(pipe,true,true);
