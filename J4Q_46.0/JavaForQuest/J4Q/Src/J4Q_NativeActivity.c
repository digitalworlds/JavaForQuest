...
JNIEXPORT jlong JNICALL Java_j4q_J4Q_stopHapticFeedbackLeft( JNIEnv * env, jclass obj )
{
...
JNIEXPORT jlong JNICALL Java_j4q_J4Q_stopHapticFeedbackRight( JNIEnv * env, jclass obj )
{
    XrHapticActionInfo hapticActionInfo = {};
    hapticActionInfo.type = XR_TYPE_HAPTIC_ACTION_INFO;
    hapticActionInfo.next = NULL;
...
JNIEXPORT jlong JNICALL Java_j4q_J4Q_applyHapticFeedbackLeft( JNIEnv * env, jclass obj, jfloat amplitude, jfloat seconds, jint frequency ) {
...
JNIEXPORT jlong JNICALL Java_j4q_J4Q_applyHapticFeedbackRight( JNIEnv * env, jclass obj, jfloat amplitude, jfloat seconds, jint frequency ) {
    XrHapticVibration vibration = {};
    vibration.type = XR_TYPE_HAPTIC_VIBRATION;
    vibration.next = NULL;
    vibration.amplitude = amplitude;
