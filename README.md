...
- [x] Start your own project using the Sandbox template, which is an empty project for you to use.
- [x] Consult the J4Q Javadocs: [https://digitalworlds.github.io/JavaForQuest/doc/index.html](https://digitalworlds.github.io/JavaForQuest/doc/index.html) 
...
1. This project was created using the Meta OpenXR SDK 46.0 and 85.0 https://developer.oculus.com/downloads/package/oculus-openxr-mobile-sdk/
