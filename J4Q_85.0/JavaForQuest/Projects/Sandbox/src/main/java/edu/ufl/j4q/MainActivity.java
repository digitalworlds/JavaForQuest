...
import gl.controllers.J4QPose;
import gl.geometry.Position;
...
public class MainActivity extends QuestActivity {
    ...
    public void Update() {
        ...
        //m.transform.rotateY(20 * J4Q.perSec()*J4Q.rightController.joystick.getX());
        //m.transform.rotateX(20 * J4Q.perSec()*J4Q.rightController.joystick.getY());

        J4QPose p=J4Q.rightController.grip;
        m.transform.identity();
        m.transform.translate(p.position);
        m.transform.rotate(p.orientation);
